...
#include "PythonQtWrapper_QPatternist.h"
#include "PythonQtWrapper_QPatternistSDK.h"
...
//PythonQt::self()->registerCPPClass("QXmlSchemaValidator", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QXmlSchemaValidator>);
PythonQt::self()->registerCPPClass("QXmlNamePool", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QXmlNamePool>);
PythonQt::self()->registerCPPClass("QPatternist", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QPatternist>);
PythonQt::self()->registerCPPClass("QPatternistSDK", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QPatternistSDK>);
...
PythonQt::self()->registerCPPClass("QXmlSchema", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QXmlSchema>);
