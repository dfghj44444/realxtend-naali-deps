...
void registerTypes()
{
    ...
    qDBusRegisterMetaType<Tp::AliasMap>();
    qDBusRegisterMetaType<Tp::AliasPair>();
    qDBusRegisterMetaType<Tp::AliasPairList>();
    qDBusRegisterMetaType<Tp::Avatar>();
    qDBusRegisterMetaType<Tp::AvatarTokenMap>();
    qDBusRegisterMetaType<Tp::CapabilityChange>();
    qDBusRegisterMetaType<Tp::CapabilityChangeList>();
    qDBusRegisterMetaType<Tp::CapabilityPair>();
    qDBusRegisterMetaType<Tp::CapabilityPairList>();
    qDBusRegisterMetaType<Tp::ChannelCallStateMap>();
    qDBusRegisterMetaType<Tp::ChannelClass>();
    qDBusRegisterMetaType<Tp::ChannelClassList>();
    qDBusRegisterMetaType<Tp::ChannelDetails>();
    qDBusRegisterMetaType<Tp::ChannelDetailsList>();
    qDBusRegisterMetaType<Tp::ChannelInfo>();
    qDBusRegisterMetaType<Tp::ChannelInfoList>();
    qDBusRegisterMetaType<Tp::ContactAttributesMap>();
    qDBusRegisterMetaType<Tp::ContactCapability>();
    qDBusRegisterMetaType<Tp::ContactCapabilityList>();
    qDBusRegisterMetaType<Tp::ContactPresences>();
    qDBusRegisterMetaType<Tp::DBusTubeMember>();
    qDBusRegisterMetaType<Tp::DBusTubeMemberList>();
    qDBusRegisterMetaType<Tp::HandleIdentifierMap>();
    qDBusRegisterMetaType<Tp::HandleOwnerMap>();
    qDBusRegisterMetaType<Tp::LastActivityAndStatuses>();
    qDBusRegisterMetaType<Tp::LocalPendingInfo>();
    qDBusRegisterMetaType<Tp::LocalPendingInfoList>();
    qDBusRegisterMetaType<Tp::MediaSessionHandlerInfo>();
    qDBusRegisterMetaType<Tp::MediaSessionHandlerInfoList>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerCandidate>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerCandidateList>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerCodec>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerCodecList>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerTransport>();
    qDBusRegisterMetaType<Tp::MediaStreamHandlerTransportList>();
    qDBusRegisterMetaType<Tp::MediaStreamInfo>();
    qDBusRegisterMetaType<Tp::MediaStreamInfoList>();
    qDBusRegisterMetaType<Tp::MessagePart>();
    qDBusRegisterMetaType<Tp::MessagePartContentMap>();
    qDBusRegisterMetaType<Tp::MessagePartList>();
    qDBusRegisterMetaType<Tp::MessagePartListList>();
    qDBusRegisterMetaType<Tp::MultipleStatusMap>();
    qDBusRegisterMetaType<Tp::ObjectPathList>();
    qDBusRegisterMetaType<Tp::ParamSpec>();
    qDBusRegisterMetaType<Tp::ParamSpecList>();
    qDBusRegisterMetaType<Tp::PendingTextMessage>();
    qDBusRegisterMetaType<Tp::PendingTextMessageList>();
    qDBusRegisterMetaType<Tp::PropertyFlagsChange>();
    qDBusRegisterMetaType<Tp::PropertyFlagsChangeList>();
    qDBusRegisterMetaType<Tp::PropertySpec>();
    qDBusRegisterMetaType<Tp::PropertySpecList>();
    qDBusRegisterMetaType<Tp::PropertyValue>();
    qDBusRegisterMetaType<Tp::PropertyValueList>();
    qDBusRegisterMetaType<Tp::QualifiedPropertyValueMap>();
    qDBusRegisterMetaType<Tp::QualifiedPropertyValueMapList>();
    qDBusRegisterMetaType<Tp::RequestableChannelClass>();
    qDBusRegisterMetaType<Tp::RequestableChannelClassList>();
    qDBusRegisterMetaType<Tp::RichPresenceAccessControl>();
    qDBusRegisterMetaType<Tp::RoomInfo>();
    qDBusRegisterMetaType<Tp::RoomInfoList>();
    qDBusRegisterMetaType<Tp::SimpleContactPresences>();
    qDBusRegisterMetaType<Tp::SimplePresence>();
    qDBusRegisterMetaType<Tp::SimpleStatusSpec>();
    qDBusRegisterMetaType<Tp::SimpleStatusSpecMap>();
    qDBusRegisterMetaType<Tp::SingleContactAttributesMap>();
    qDBusRegisterMetaType<Tp::SocketAddressIP>();
    qDBusRegisterMetaType<Tp::SocketAddressIPList>();
    qDBusRegisterMetaType<Tp::SocketAddressIPv4>();
    qDBusRegisterMetaType<Tp::SocketAddressIPv6>();
    qDBusRegisterMetaType<Tp::SocketNetmaskIPv4>();
    qDBusRegisterMetaType<Tp::SocketNetmaskIPv6>();
    qDBusRegisterMetaType<Tp::StatusSpec>();
    qDBusRegisterMetaType<Tp::StatusSpecMap>();
    qDBusRegisterMetaType<Tp::StringStringMap>();
    qDBusRegisterMetaType<Tp::StringStringMapList>();
    qDBusRegisterMetaType<Tp::StringVariantMap>();
    qDBusRegisterMetaType<Tp::StringVariantMapList>();
    qDBusRegisterMetaType<Tp::SupportedSocketMap>();
    qDBusRegisterMetaType<Tp::TubeInfo>();
    qDBusRegisterMetaType<Tp::TubeInfoList>();
