 ...
 * interface. See the FUTURE.InitialAudio property for details of the 
...
enum ConnectionStatus
{
    ...
    /**
     * The connection has not yet been established, or has been severed and 
     * reconnection is being attempted. Some methods may fail until the 
     * connection has been established.
     */
     ConnectionStatusConnecting = 1,

    /**
     * The connection has been severed and no method calls are valid. The 
     * object may be removed from the bus at any time.
     */
 ...
 */
const int NUM_MEDIA_STREAM_ERRORS = (1+1);
 ...
 * 
 * The requested channel or other resource already exists, and another client 
 ...
 * &quot;busy&quot; indication. This corresponds to Busy in the 
 * Channel_Group_Change_Reason enum.
 */
