...
static DebugKeyToDomain key_to_domain[] = {
  ...
  { TP_DEBUG_PROPERTIES,  "/properties" },
  { TP_DEBUG_IM,          "/im" },
  { TP_DEBUG_CONNECTION,  "/connection" },
  { TP_DEBUG_PARAMS,      "/params" },
  { TP_DEBUG_PRESENCE,    "/presence" },
  { TP_DEBUG_MANAGER,     "/manager" },
  { TP_DEBUG_CHANNEL,     "/channel" },
  { TP_DEBUG_PROXY,       "/proxy" },
  { TP_DEBUG_HANDLES,     "/handles" },
  { TP_DEBUG_CONTACTS,    "/contacts" },
  { TP_DEBUG_ACCOUNTS,    "/accounts" },
  { TP_DEBUG_DISPATCHER,  "/dispatcher" },
  { 0, NULL }
};
